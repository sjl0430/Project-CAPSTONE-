...
import 'view_screen.dart'; // view 모드로 전환
...
class _ScanScreenState extends State<ScanScreen> {
  ...
  final Set<String> _connectedDeviceIds = {}; // remoteId (string) 기반으로 추적
    ...
    return ScaffoldMessenger(
      ...
      child: Scaffold(
        ...
        floatingActionButton: Padding(
          padding: const EdgeInsets.only(right: 2), // 오른쪽에 여백을 줍니다.
          child: Row(
            ...
            children: <Widget>[
              ...
              const SizedBox(width: 6), // 버튼들 간의 간격을 추가합니다.

              // 그래픽 버튼
              FloatingActionButton(
                onPressed: () {
                  final connectedDevices = _filteredResults
                      .where((r) => _connectedDeviceIds.contains(r.device.remoteId.str))
                      .toList();
